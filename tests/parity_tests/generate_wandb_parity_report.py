...
DEFAULT_PROJECTS = ("hiddenstates", "attntracker", "corereranker", "steering", "spotlight")
L2_KEYS = (
    "q_l2_mean",
    "k_l2_mean",
...
PARITY_KEYS = (
    ...
    "text_changed_by_spotlight",
    "tokens_changed_by_spotlight",
    "spotlight_alpha",
)
...
def metric_label(key: str) -> str:
    labels = {
        ...
        "text_changed_by_spotlight": "Text changed by Spotlight",
        "tokens_changed_by_spotlight": "Tokens changed by Spotlight",
        "spotlight_alpha": "Spotlight alpha",
    }
